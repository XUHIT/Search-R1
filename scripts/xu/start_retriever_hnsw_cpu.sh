...
RETRIEVAL_DIR=${RETRIEVAL_DIR:-${DATA_ROOT}/retrieval/wiki18_e5_hnsw64}
INDEX_PATH=${INDEX_PATH:-${RETRIEVAL_DIR}/e5_HNSW64.index}
CORPUS_PATH=${CORPUS_PATH:-${DATA_ROOT}/retrieval/wiki18_e5_flat/wiki-18.jsonl}
